...
[`splinterd` man page]({% link docs/0.7/references/cli/splinterd.1.md %}).

For more details about Biome and credentials, see
[Biome User Management]({% link docs/0.7/concepts/biome_user_management.md %}).
...
docs/0.7/references/cli/splinter-role-list.1.md %}) and [`splinter role
show`]({% link docs/0.7/references/cli/splinter-role-show.1.md %}).  The `list`
...
docs/0.7/references/cli/splinter-role-create.1.md %}) subcommand.  The roles
...
docs/0.7/references/cli/splinter-role-update.1.md %}) subcommand.  A role's
...
docs/0.7/references/cli/splinter-role-delete.1.md %}) subcommand.  Any
...
docs/0.7/references/cli/splinter-authid-list.1.md %}) and [`splinter authid
show`]({% link docs/0.7/references/cli/splinter-authid-show.1.md %}).  The
...
docs/0.7/references/cli/splinter-authid-create.1.md %}) subcommand.  An identity
...
docs/0.7/references/cli/splinter-authid-update.1.md %}) subcommand.  Roles may
...
link docs/0.7/references/cli/splinter-authid-delete.1.md %}) subcommand. An
